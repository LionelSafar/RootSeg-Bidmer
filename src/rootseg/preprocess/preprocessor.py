...
if __name__ == '__main__':
    ...
    argparser.add_argument('--tubes_list', type=str, nargs='+', default=None,
    ...
    argparser.add_argument('--img_height', type=int, default = 8784,
